...
let newVallue = {
    ...
    breadcrumbs: [
        ...
        { id: 2, name: "Clothing", href: "Clothing" },
    ],
    highlights: [
...
const product = useState<Product>(() => newVallue)
const selectedColor = ref(newVallue.colors[0])
const selectedSize = ref(newVallue.sizes[2])

watchEffect(() => {
    product.value = newVallue;
});
...
<template>
    <div class="bg-white flex justify-center">
        <div class="mx-4 lg:max-w-4xl mb-10">
            <h2 class="text-2xl font-bold tracking-tight text-gray-500 mt-9 mb-7 ml-2">Review the product</h2>
            <div class=" pt-6 my-5 px-4 lg:px-8 rounded-md border-2 border-gray-200 ">
                ...
                <!-- Product info -->
                <div
                    class="mx-auto max-w-2xl px-4 pb-6 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-10 lg:pt-16">
